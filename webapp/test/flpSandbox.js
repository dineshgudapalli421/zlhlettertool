		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Letter tool",
									"targetURL": "#comsaplhbizlhlettertool-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhbizlhlettertool-display": {
								"semanticObject": "comsaplhbizlhlettertool",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.bi.zlhlettertool",
									"url": sap.ui.require.toUrl("com/sap/lh/bi/zlhlettertool")
								}
							}
						}
					}
